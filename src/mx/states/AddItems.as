...
//    protected function getRelatedIndex(parent:UIComponent, dest:Object):int
    protected function getRelatedIndex(parent:Object, dest:Object):int
    {
        var index:int = -1;
...
//    protected function addItemsToContentHolder(dest:IVisualElementContainer, items:Array):void
    protected function addItemsToContentHolder(dest:*, items:Array):void
    {
        if (startIndex == -1)
...
//    protected function addItemsToContainer(dest:IChildList, items:Array):void
    protected function addItemsToContainer(dest:*, items:Array):void
    {
        if (startIndex == -1)
...
//    protected function addItemsToIList(list:IList, items:Array):void
    protected function addItemsToIList(list:*, items:Array):void
    {       
        if (startIndex == -1)
...
//    protected function removeItemsFromIList(list:IList):void
    protected function removeItemsFromIList(list:*):void
    {
